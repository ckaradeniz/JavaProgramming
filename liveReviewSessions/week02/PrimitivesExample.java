...
public class PrimitivesExample {
    ...
    public static void main(String[] args) {
        ...
        num1 = 54; // initializing variable

        byte num2 = 123; //declaring and initializing at the same line

        int distance = 100000;

        long metres = 662211199929191L;

        long shortDistance = 1000000; // we dont need to put L this time, because its smaller than limits
