...
// from Discord : Hi Oscar can you explain a bit how we can crate a variable called address by concatenating
// ( String street, city, state) and int zipcode, from patient information
