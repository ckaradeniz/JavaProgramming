...
public class MapPractice1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(employeeMap);//{Kakalina=F, Glad=F, Jereme=Male, Bertrando=Male, Winfred=Male, Marika=F, Ddene=F, Selle=F, Orlando=Male, Brigitte=F, Desirae=F, Derk=Male, Ajay=F}
