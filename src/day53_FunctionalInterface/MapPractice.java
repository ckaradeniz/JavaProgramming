...
public class MapPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("name1 = " + name1);//name1 = Custom Class
        System.out.println("max = " + max);//max = 23.5

        System.out.println("name2 = " + name2);//name2 = Branching Statements
        System.out.println("min = " + min);//min = 1.5
